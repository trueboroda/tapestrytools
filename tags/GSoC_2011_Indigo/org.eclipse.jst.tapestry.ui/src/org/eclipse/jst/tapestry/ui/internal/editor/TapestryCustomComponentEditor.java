        ...
        public void propertyChange(PropertyChangeEvent evt) {
            if ("cycleList".equals(evt.getPropertyName())) {
                ...
                if (newSubBundles != null && !newSubBundles.isEmpty()) {
                	...
                	TapestryCustomComponentEditor editor = TapestryCustomComponentEditor.this;
                    //ensurePageExists(BUNDLELIST_PAGE, new ClassCycleListPage(editor, model, BUNDLELIST_PAGE, "Source"), 0);
                }
            }
        }
    };
