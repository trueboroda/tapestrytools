 ...
 *
 */
public class TapestryFacetException extends CoreException {
	 ...
	 * @param msg
	 */
	public TapestryFacetException(String msg) {
		super(new Status(IStatus.ERROR, TapestryCorePlugin.PLUGIN_ID, msg));
	}
