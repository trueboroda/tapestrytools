...
public interface CMDocType {
	 ...
	 * Tapestry 5 files 
	 */
	public final static String TAPESTRY5_DOC_TYPE = "TAPESTRY5";//$NON-NLS-1$
	/**
	 * Tapestry 5 custom components 
	 */
	public final static String TAPESTRY5_CUSTOM_DOC_TYPE = "TAPESTRY5CUSTOMCOMPONENT";
}
